...
public class CpuActivity extends Activity {
    ...
    private void refresh() {
        // setValue(cppHIDLRetTV, FooJavaServices.getCpu().getTest().trim());

        try {
            setValue(javaHIDLRetTV, FooJavaServices.getCpuHJ().getTest().trim());
    ...
    public void onClick(View view) {
        ...
        // [-----------------------------------------------------------]
        // setSuccess(cppHIDLRetTV, FooJavaServices.getCpu().setTest(setValue));

        // [---------------- com.eightman -----------------------]
        // [ android_app: /vendor/app/EightmanServices/          ]
        // [                     |/\/\|                          ]
        // [ hidl_interface: vendor.eightman.cpu@1.0-JAVA source ]
        // [-----------------------------------------------------]
        //                         ||
        //                    /dev/hwbinder
        //                         ||
        ...
        // [-----------------------------------------------------------]
        try {
            setSuccess(javaHIDLRetTV, FooJavaServices.getCpuHJ().setTest(setValue));
        } catch (android.os.RemoteException e) {
            Log.e("CpuActivity", "cpu HIDL Java proxy returned error", e);
        }
    }
